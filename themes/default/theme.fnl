...
(set theme.font "FiraCode Nerd Font Mono 15")
...
(set theme.border_color_normal "#000000")

(set theme.border_color_active "#535d6c")

(set theme.border_color_marked "#91231c")
...
(rnotification.connect_signal "request::rules"
                              (fn []
                                (rnotification.append_rule {:properties {:bg "#ff0000"
                                                                         :fg "#ffffff"}
